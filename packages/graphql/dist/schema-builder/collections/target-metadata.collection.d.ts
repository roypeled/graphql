...
export declare class TargetMetadataCollection {
  ...
  classDirectives: ArrayWithGlobalCacheCollection<
    import('../metadata').DirectiveMetadata
  >;
  classExtensions: ArrayWithGlobalCacheCollection<
    import('../metadata').ExtensionsMetadata
  >;
